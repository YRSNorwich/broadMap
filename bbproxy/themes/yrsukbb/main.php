...
<body>
   <header>
        ...
        <nav>
            ...
            <a href="../bbproxy"><img src="../images/speed(h).png"/></a>
...
?>
      ...
      <p class="center">&copy; 2011 <a href="index.php"><!--[site_name]--></a> : Powered by <a href="http://www.glype.com/">glype</a> <!--[version]--></p>
